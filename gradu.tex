...
\colorbox{YellowGreen}{// TODO: Kuvakaappausten esittely.}
...
\colorbox{YellowGreen}{// TODO: Tarkenna muistinkäyttöön liittyvät asiat.}

Progressiivisten WWW-sovellusten muistinkäyttöä arvioitiin kappaleessa xx. Muistinkäyttöä mitattiin Firefox-selaimen kehitystyökaluilla ottamalla mittauksia sekä ohjelman alkutilassa \ref{fig:memory-use-idle} sekä käytön aikana \ref{fig:memory-use-stress}. Lisäksi muistinkäyttöä seurattiin samalla tavoin Chromium-selaimen kehitystyökaluilla ohjelman alkutilassa \ref{fig:chromium-memory-use-idle} sekä käytön aikana \ref{fig:chromium-memory-use-stress}. 
...
\begin{center}
    ...
    Viestin kirjoittaminen & 4 + (x * symbolien lisääminen viestiin)\\ \hline
    Kortin luonti & 5 + (x * symbolien lisääminen kortille) \\ \hline
    Kortin poisto & 3  \\ \hline
    \end{tabular}
\end{center}

Välivaiheiden määräästä ei voi suoraan muodostaa täyttä kuvaa ohjelmiston tehokkuudesta. Voidaan kuitenkin 
...
\colorbox{YellowGreen}{// TODO: Heuristiikkaviittaus pois.}
Tyydyttävyyttä on hankala mitata ilman koekäyttäjiä, mutta yleisten laatutekijöiden huomioon ottaminen lisää tyydyttävyyttä. Voidaan esimerkiksi olettaa, että ohjelmiston yhtenäinen ulkoasu lisää opittavuuden ja tehokkuuden lisäksi myös tyydyttävyyttä.
...
Olemassa olevan tutkimuksen pohjalta luotujen vaatimusten noudattaminen ei tuottanut ongelmia. 
